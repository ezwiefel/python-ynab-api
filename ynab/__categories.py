...
class Category:
    ...
    @classmethod
    def from_dict(cls, data: dict, category_name: str = None):
        known_args = {}
        unknown_args = {}
...
class CategoriesAPI(RESTBase):
    ...
    def __load_categories_from_json(data: dict):
        ...
        for group in data['data']['category_groups']:
            ret_list.extend([Category.from_dict(c, category_name=group['name']) for c in group['categories']])
